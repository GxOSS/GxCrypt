...
void ExCryptSha(const uint8_t* input1, uint32_t input1_size, const uint8_t* input2,
                uint32_t input2_size, const uint8_t* input3, uint32_t input3_size, uint8_t* output,
                uint32_t output_size);

void ExCryptRotSumSha(const uint8_t* input1, uint32_t input1_size, const uint8_t* input2,
                      uint32_t input2_size, uint8_t* output, uint32_t output_size);
...
void ExCryptHmacSha(const uint8_t* key, uint32_t key_size, const uint8_t* input1,
                    uint32_t input1_size, const uint8_t* input2, uint32_t input2_size,
                    const uint8_t* input3, uint32_t input3_size, uint8_t* output,
                    uint32_t output_size);
uint8_t ExCryptHmacShaVerify(const uint8_t* key, uint32_t key_size, const uint8_t* input1,
                             uint32_t input1_size, const uint8_t* input2, uint32_t input2_size,
