...
#define v_cycle(i, j)                                                                              \
    vf(7, i) +=                                                                                    \
        (j ? hf(i) : p[i]) + k_0[i + j] + s_1(vf(4, i)) + ch(vf(4, i), vf(5, i), vf(6, i));        \
    vf(3, i) += vf(7, i);                                                                          \
...
const uint32_t i256[8] = {0x6a09e667ul, 0xbb67ae85ul, 0x3c6ef372ul, 0xa54ff53aul,
...
void ExCryptSha256(const uint8_t* input1, uint32_t input1_size, const uint8_t* input2,
                   uint32_t input2_size, const uint8_t* input3, uint32_t input3_size,
...
#if !defined(bswap_64)
#define bswap_64(x)                                                                                \
    (((uint64_t) (bswap_32((uint32_t) (x)))) << 32 | bswap_32((uint32_t) ((x) >> 32)))
#endif
...
#define bsw_64(p, n)                                                                               \
    {                                                                                              \
        int _i = (n);                                                                              \
        while (_i--)                                                                               \
            ((uint64_t*) p)[_i] = bswap_64(((uint64_t*) p)[_i]);                                   \
    }
#else
#define bsw_64(p, n)
#endif
...
const uint64_t i384[80] = {0xcbbb9d5dc1059ed8, 0x629a292a367cd507, 0x9159015a3070dd17,
...
void ExCryptSha384(const uint8_t* input1, uint32_t input1_size, const uint8_t* input2,
                   uint32_t input2_size, const uint8_t* input3, uint32_t input3_size,
                   uint8_t* output, uint32_t output_size) {
...
void ExCryptSha512(const uint8_t* input1, uint32_t input1_size, const uint8_t* input2,
                   uint32_t input2_size, const uint8_t* input3, uint32_t input3_size,
                   uint8_t* output, uint32_t output_size) {
...
const uint32_t i224[8] = {0xc1059ed8ul, 0x367cd507ul, 0x3070dd17ul, 0xf70e5939ul,
